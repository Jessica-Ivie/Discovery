			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="comment.student.label" default="Student" /></th>
				...
				<g:each in="${commentInstanceList}" status="i" var="commentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${commentInstance.id}">${fieldValue(bean: commentInstance, field: "note")}</g:link></td>
					
						<td>${fieldValue(bean: commentInstance, field: "student")}</td>
