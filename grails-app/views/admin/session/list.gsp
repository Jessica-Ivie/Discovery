			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="theme" title="${message(code: 'session.theme.label', default: 'Theme')}" />
				...
				<g:each in="${sessionInstanceList}" status="i" var="sessionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${sessionInstance.id}">${fieldValue(bean: sessionInstance, field: "theme")}</g:link></td>
